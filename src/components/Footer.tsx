      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="space-y-3.5">
            ...
            <div className="flex gap-3 pt-2">
              <a
                ...
                className="w-11 h-11 sm:w-9 sm:h-9 min-w-[44px] min-h-[44px] sm:min-w-[36px] sm:min-h-[36px] rounded-full border border-[#F7F1E5]/20 flex items-center justify-center cursor-pointer hover:bg-[#E2A69B] hover:border-[#E2A69B] active:scale-95 transition-all text-white"
              >
        ...
        <div className="pt-6 border-t border-[#E2A69B]/20 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-[#F7F1E5]/70 text-center sm:text-left">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              onClick={scrollToTop}
              className="w-11 h-11 sm:w-8 sm:h-8 min-w-[44px] min-h-[44px] sm:min-w-[32px] sm:min-h-[32px] rounded-full border border-[#F7F1E5]/30 flex items-center justify-center hover:bg-[#E2A69B] hover:border-[#E2A69B] active:scale-95 transition-all text-white cursor-pointer"
              title="Наверх"
